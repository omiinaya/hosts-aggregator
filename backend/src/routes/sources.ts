...
router.patch(
  '/:id/toggle',
  validateIdParam,
  sourcesController.toggleSource.bind(sourcesController)
);
...
router.post(
  '/:id/refresh',
  validateIdParam,
  sourcesController.refreshSource.bind(sourcesController)
);
...
router.post(
  '/:id/refresh-cache',
  validateIdParam,
  sourcesController.refreshCache.bind(sourcesController)
);
...
router.get(
  '/:id/detect-format',
  validateIdParam,
  sourcesController.detectFormat.bind(sourcesController)
);
